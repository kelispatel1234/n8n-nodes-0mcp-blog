...
export class Node0mcpBlog implements INodeType {
  ...
  public async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    for (let itemIndex = 0; itemIndex < inputItems.length; itemIndex += 1) {
      ...
      try {
        ...
        credentialApplications = ([{"credentialType":"node0mcpBlogApi","type":"apiKey","location":"header","parameter":"X-API-Key"}]) as CredentialApplication[];
