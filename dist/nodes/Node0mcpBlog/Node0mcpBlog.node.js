...
class Node0mcpBlog {
    constructor() {
        this.description = {
            displayName: "0mcp Blog",
            name: "node0mcpBlog",
            icon: {
                light: "file:node0mcpBlog.svg",
                dark: "file:node0mcpBlog.dark.svg"
            },
            group: [],
            version: [
                1
            ...
            description: "This Repository is for Admin to manage blogs",
            hints: [
                {
            ...
            try {
                ...
                switch (operation) {
                    case "deleteApiBlogsId": {
                        ...
                        credentialApplications = ([{ "credentialType": "node0mcpBlogApi", "type": "apiKey", "location": "header", "parameter": "X-API-Key" }]);
...
exports.Node0mcpBlog = Node0mcpBlog;
//# sourceMappingURL=Node0mcpBlog.node.js.map